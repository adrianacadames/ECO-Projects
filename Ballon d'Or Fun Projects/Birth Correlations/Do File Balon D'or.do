...
Purpose: Is there an association between winning the Ballon d'Or and being born in early months of the year?
Adriana Adames Acosta
Start 6-24-2025
*/
...
replace winningyear1 = 2024 in 45
replace Nwins = 1 in 45

replace player = "Ousmane Dembele" in 46
replace bmonth = 5 in 46
replace bday = 15 in 46
replace byear = 1997 in 46
replace country = "France" in 46
replace winningyear1 = 2025 in 46
replace Nwins = 1 in 46
...
reg Nwins i.bmonth
//No significant correlation with a specific month

gen yearthird = .
replace yearthird = 1 if bmonth <= 4
replace yearthird = 2 if bmonth > 4 & bmonth <= 8
replace yearthird = 3 if bmonth > 8

reg Nwins i.yearthird